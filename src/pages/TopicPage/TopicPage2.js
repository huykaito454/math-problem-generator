...
const TopicPage2 = () => {
    ...
    return (
        <div className="w-full page-container flex flex-col my-10 gap-y-10">
            <div className="w-full p-16 bg-primary text-white text-6xl rounded-3xl">Topic</div>
            <div className="w-full flex items-start justify-between">
                <div className="w-[40%] p-8 bg-whit shadow-md flex flex-col gap-y-6 text-black rounded-3xl">
                    ...
                    {topics.length > 0 &&
                        topics.map((item) => (
                            <div key={item.id} className="flex items-center justify-between border-b pb-4 border-gray-300">
                                <div className="flex items-center justify-center gap-x-8">
                                    <div className="">
                                        <img src="https://img.icons8.com/color/96/000000/pixel-star.png" alt="" className="w-14" />
                                    </div>
                                    <div>
